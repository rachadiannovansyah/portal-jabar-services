...
var querySelectNews = `SELECT id, category, title, excerpt, content, image, video, slug, author_id, type, views, shared, source, status, is_live, created_at, updated_at FROM news`
