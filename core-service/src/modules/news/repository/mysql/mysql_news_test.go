...
func TestFetch(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "category", "title", "excerpt", "content", "image", "video", "slug", "author", "reporter", "editor", "area_id", "type", "views", "shared", "source", "duration", "start_date", "end_date", "status", "is_live", "link", "published_at", "created_by", "created_at", "updated_at"}).
